fdata = {
  ...
  ferries: {
    ...
    alfageln: {
      name: "M/S Alfågeln",
      features: { access: true, cafe: true },
      capacity: { persons: 244, cars: 36, trucks: 4 },
      contact: {
    ...
    viggen: {
      ...
      contact: {
        phones: ['+358 (0)40 0330 455', {name: 'Café', tel: '+358 (0)400 296 222'}]
      },
    },
    adan: {
      name: "M/S Ådan",
      features: { access: true, cafe: true },
      capacity: { persons: 145, cars: 38, trucks: 4 },
      contact: {
        phones: ['+358 (0)40 4879 205', {name: 'Café', tel: '+358 (0)401 965 771'}]
      },
    },
    doppingen: {
      name: "M/S Doppingen",
    ...
    mergus: {
      name: "M/S Mergus",
      features: { access: true, cafe: false },
      capacity: { persons: 99, cars: 26, trucks: 2 },
      contact: {
        phones: ['+358 400 493 555']
      },
    },
    angosundslinjen: {
    ...
    msjurmo: {
      ...
      contact: {
        ...
        fb: 'https://www.facebook.com/p/MS-Jurmo-100063719131124/',
        email: 'jurmo.bridge@finferries.fi',
      },
    },
    alva: {
      name: "M/S Alva",
...
//    NaantaliVanhakaupunki: { name: "Naantalin vanhakaupunki", name_sv: "Nådendals gamla stan", name_en: "Naantali Old Town", mun: "Naantali" },
  ...
  timetables: {
    ...
    rymattylanreitti: {
      link: "https://www.finferries.fi/lauttaliikenne/lauttapaikat-ja-aikataulut/rymattylan-reittialue.html",
    ...
    hitisjurmo: {
      name: "M/S Jurmo",
      link: "https://www.finferries.fi/lauttaliikenne/lauttapaikat-ja-aikataulut/hiittisten-reittialue.html",
    ...
    hitisalva: { 
      name: "M/S Alva",
      link: "https://www.finferries.fi/lauttaliikenne/lauttapaikat-ja-aikataulut/hiittisten-itainen-reitti.html",
